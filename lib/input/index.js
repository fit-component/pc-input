    ...
    _createClass(Input, [{
        ...
        value: function render() {
            ...
            var iconClass = (0, _classnames2.default)((_classNames = {
                'fa': true
            }, _defineProperty(_classNames, 'fa-' + this.state.icon, true), _defineProperty(_classNames, 'icon', true), _classNames));
            ...
            return _react2.default.createElement(
                ...
                this.state.icon && _lodash2.default.isEmpty(this.props.label) && _lodash2.default.isEmpty(this.props.addonLeft) && _lodash2.default.isEmpty(this.props.addonRight) ? _react2.default.createElement('i', { onMouseEnter: this.handleIconMouseEnter.bind(this), onClick: this.props.handleIconClick, onMouseLeave: this.handleIconMouseLeave.bind(this), className: iconClass }) : null,
